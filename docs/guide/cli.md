...
| 命令 | 说明 |
|------|------|
| `@validpilot/ai-verify-mcp health` | 健康检?|
| `@validpilot/ai-verify-mcp validate` | 一键快速验?|
| `ai-verify-mcp run` | 执行验证流程 |
| `@validpilot/ai-verify-mcp start` | 启动 MCP Server |
| `@validpilot/ai-verify-mcp --version` | 查看版本 |
